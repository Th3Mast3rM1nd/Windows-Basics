...
The C:\ Directory We can Call as well the boot Directory because From the OS start the booting. The Directory Structure Of The ```C:\```:
| Directory | Description 
|---------------|----------------|
|/Perflogs: |  Holds Performance Logs but are empty.
...
|/Users: | This Directory Contains Users Profile 
